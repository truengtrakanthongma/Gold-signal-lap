...
const ORDER = ['indicators', 'patterns', 'classic', 'levels', 'macro', 'signals', 'narrate', 'backtest', 'strategy', 'sources', 'chart', 'discord', 'alerts', 'feed', 'tour', 'glossary', 'instrument', 'news', 'newsfactor', 'learn', 'adapt', 'app'];
